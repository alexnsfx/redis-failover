...
function launchsentinel() {
  ...
  echo "sentinel down-after-milliseconds mymaster ${DOWN_AFTER_MS:-60000}" >> ${sentinel_conf}
  echo "sentinel failover-timeout mymaster ${FAILOVER_TIMEOUT_MS:-180000}" >> ${sentinel_conf}
